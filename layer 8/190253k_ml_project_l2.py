...
Original file is located at
    https://colab.research.google.com/drive/1m7CVUrQvpXy7LIHq5YoKlDVd5dO_z8z7
"""
...
# Use KNeighborsClassifier since it has the highest accuracy
...
X_2_train = selector.fit_transform(X_2_train, Y_2_train)
X_2_valid = selector.transform(X_2_valid)
X_2_test = selector.transform(X_2_test)

X_2_train.shape

model.fit(X_2_train, Y_2_train)
y_2_pred_after = model.predict(X_2_valid)
print(classification_report(Y_2_valid, y_2_pred_after))

pca=PCA(0.85)
pca = pca.fit(X_2_train)

x_2_train_pca=pca.fit_transform(X_2_train)
x_2_valid_pca = pca.transform(X_2_valid)
...
param_grid = {
    ...
    'p': [1, 2],  # Minkowski distance metric parameter (1 for Manhattan, 2 for Euclidean)
}
